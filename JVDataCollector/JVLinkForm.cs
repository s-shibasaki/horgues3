...
namespace JVDataCollector
{
    public partial class JVLinkForm : Form
    {
        ...
        private void ExecuteUpsertBatch(string tableName, NpgsqlConnection connection)
        {
            ...
            Console.WriteLine($"Executing UPSERT batch for table '{tableName}' with {buffer.Count} records...");
            ...
            var valueParams = string.Join(", ", allColumns.Select(col => $"@{col}"));
            ...
            Console.WriteLine($"UPSERT batch completed successfully for table '{tableName}' with {buffer.Count} records.");
